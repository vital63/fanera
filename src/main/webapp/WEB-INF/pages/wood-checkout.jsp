                ...
                <section id="checkout-page">
                    <div class="container">
                        <div class="col-xs-12 no-margin">
                            ...
                            <form:form action="${pageContext.request.contextPath}/wood-checkout" method="POST" commandName="order">
                                <div class="billing-address">
                                    ...
                                    <div class="row field-row">
                                        <div class="col-xs-12 col-sm-6">
                                            ...
                                            <form:input  class="le-input"  path="username" name="username" type="text"/> <br/> 
                                            <form:errors style="color:red;" path="username" cssClass="error" ></form:errors>
                                        </div>
                                    </div><!-- /.field-row -->
                                            ...
                                            <c:forEach var="item" items="${cart.items}">
                                                <div class="row no-margin order-item">
                                                    ...
                                                    <div class="col-xs-12 col-sm-9 ">
                                                        <div class="title"><a href="#">${item.wood.name} </a></div>
                                                        <div class="brand">id: ${item.wood.id}</div>
                                                    </div>
