...
<div class="logo">
    <a href="index">
        <!--<img alt="vmc_and_hmc" src="${pageContext.request.contextPath}/resources/images/vmc_and_hmc.svg" width="233" height="54"/>-->
        <!--<img alt="logo_vmccnc" src="${pageContext.request.contextPath}/resources/images/logo_vmccnc.jpg" width="233" height="54"/>-->
        <!--<img alt="logo_vmccnc" src="${pageContext.request.contextPath}/resources/images/vmc_hmc.jpg" width="233" height="54"/>-->
        <!--<object id="sp" type="image/svg+xml" data="${pageContext.request.contextPath}/resources/assets/images/logo.svg" width="233" height="54"></object>-->
        <object id="sp" type="image/svg+xml" data="${pageContext.request.contextPath}/resources/assets/images/vmc_and_hmc.svg" width="233" height="54"></object>
...
<!--    <div class="phone inline">
        <i class="fa fa-phone"></i> USA: <span class="le-color">+1 203 556-50-69</span> 
        Russia: <span class="le-color">+375 29 255-88-88</span>
    </div>-->
<!--    <div class="contact inline">
    ...
    <div >
         <i ></i><spring:message code="header.allmachines_have_warranty" text="All CNC machines have warranty 6 months or 1 year" />
    </div>
</div><!-- /.contact-row -->
<!-- ============================================================= SEARCH AREA ============================================================= -->
...
<!--            <ul class="categories-filter animate-dropdown">
            ...
            <!--<a class="search-button" href="searchmvc" ></a>-->    
            <!--<button class="search-button"  > rrr</button>-->    
...
<!--        <div class="wishlist ">
            <a href="wishlist"><i class="fa fa-heart"></i> wishlist <span class="value">${wishlistCart.numberOfItems}</span> </a>
        </div>-->
<c:if test="${compareCartVmc.numberOfItems>0}" >
    <div class="compare">
        <a href="/compare-vmc"><i class="fa fa-exchange"></i> VMC <span class="value">${compareCartVmc.numberOfItems}</span> </a>
    </div>
</c:if>
...
<c:if test="${compareCartLight.numberOfItems>0}" >
    <div class="compare">
        <a href="/compare-light">
            <i class="fa fa-exchange"></i> Light <span class="value">${compareCartLight.numberOfItems}</span> 
        </a>
    </div>
</c:if>
        ...
        <div class="basket">
            ...
            <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                ...
                <div class="total-price-basket"> 
                    <span class="lbl"><spring:message code="header.yourcart" text="your cart" />:</span>
...
<c:forEach  items="${cart.items}" var="prod" >
                <li>
...
<!--                <li>
                    <div class="basket-item">
                        <div class="row">
                            <div class="col-xs-4 col-sm-4 no-margin text-center">
                                <div class="thumb">
                                    <img alt="" src="${pageContext.request.contextPath}/resources/images/products/product-small-01.jpg" />
                                </div>
                            </div>
                            <div class="col-xs-8 col-sm-8 no-margin">
