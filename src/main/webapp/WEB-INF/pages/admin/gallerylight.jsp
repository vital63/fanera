...
<head>
    ...
    <link href="${pageContext.request.contextPath}/resources/admin/css/gray.css" rel="stylesheet" type="text/css" media="screen"/>
        ...
        <div class="tabs box">
            ...
            <div class="box-content">
                ...
                <div id="gallery">
                    <div class="container-fluid">
                        <div class="row no-margin">
                            <c:forEach items="${imageListLight}" var="image">
                                <div class="item col-xs-4 col-sm-2">
                                    <a href="/admin/light/photos/remove?image=${image}" class="ico ico-delete" style="float: left"></a>
                                    <img class="img-responsive" src="${pageContext.request.contextPath}/resources/assets/images/products/light/office/${image}" href="${pageContext.request.contextPath}/resources/assets/images/products/light/office/${image}"/>
                ...
                <div id="upload">
                    ...
                    <form class="formBox" method="post" action="/admin/light/photos/upload" enctype="multipart/form-data">

                        <fieldset>
                            <div class="clearfix file">
                                <div class="lab"><label for="imageFile">Upload images</label></div>
                                <div class="con">
                                    <input type="file" accept="image/*" name="imageLathe" class="upload-file"
