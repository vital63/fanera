        ...
        <div class="tabs box">
            ...
            <div class="box-content">
                ...
                <div id="gallery">
                    <div class="container-fluid">
                        <div class="row no-margin">
                            <c:forEach items="${imageListWood}" var="image">
                                <div class="item col-xs-4 col-sm-2">
                                    <a href="/admin/wood/photos/remove?image=${image}" class="ico ico-delete" style="float: left"></a>
                                    <img class="img-responsive" src="${pageContext.request.contextPath}/resources/assets/images/products/wood/${image}" href="${pageContext.request.contextPath}/resources/assets/images/products/wood/${image}"/>
                ...
                <div id="upload">
                    ...
                    <form class="formBox" method="post" action="/admin/wood/photos/upload" enctype="multipart/form-data">
