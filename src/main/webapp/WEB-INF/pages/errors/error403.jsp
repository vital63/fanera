...
<head>
    ...
    <title>HMC. 403 - <spring:message code="error.403" text="Error 403"/></title>
        ...
        <div class="row">
            <div class="col-md-8 center-block">
                <div class="info-404 text-center">
                    ...
                    <h1 class="lead"><spring:message code="error.full403" text="Error 403"/></h1>

                    <div class="text-center">
                        <!--<a href="/admin/adminEntry" class="btn-lg huge"><i class="fa fa-key"></i>
                            <spring:message  code="error.goToAuthorization"/></a><br>
                    -->
                        <br>
