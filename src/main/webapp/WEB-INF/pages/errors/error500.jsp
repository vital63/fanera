...
<head>
    ...
    <title>HMC. 500 - <spring:message code="error.500" text="Error 500"/></title>
        ...
        <div class="row">
            <div class="col-md-8 center-block">
                <div class="info-404 text-center">
                    ...
                    <h1 class="lead"><spring:message code="error.full500" text="Error 500"/></h1>

                    <div class="text-center">
                        <a href="/" class="btn-lg huge"><i class="fa fa-home"></i> 
                            <spring:message  code="error.goToHomePage" text="To Home Page"/>
                        </a>
                    </div>
                </div>
            </div>
