        ...
        <ul>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-3 no-margin">
                        <a href="#" class="thumb-holder">
                            <img alt="" src="${pageContext.request.contextPath}/resources/assets/images/blank.gif" data-echo="${pageContext.request.contextPath}/resources/assets/images/products/product-small-01.jpg" />
                        </a>
                    </div>
                </div>
            </li>
            ...
            <li>
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-3 no-margin">
                        <a href="#" class="thumb-holder">
                            <img alt="" src="${pageContext.request.contextPath}/resources/assets/images/blank.gif" data-echo="${pageContext.request.contextPath}/resources/assets/images/products/product-small-02.jpg" />
                        </a>
                    </div>
                </div>
            </li>
            ...
            <li>
                <div class="row">                        
                    ...
                    <div class="col-xs-12 col-sm-3 no-margin">
                        <a href="#" class="thumb-holder">
                            <img alt="" src="${pageContext.request.contextPath}/resources/assets/images/blank.gif" data-echo="${pageContext.request.contextPath}/resources/assets/images/products/product-small-03.jpg" />
                        </a>
                    </div>
                </div>
            </li>
        ...
        <ul>
            <li>
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-3 no-margin">
                        <a href="#" class="thumb-holder">
                            <img alt="" src="${pageContext.request.contextPath}/resources/assets/images/blank.gif" data-echo="${pageContext.request.contextPath}/resources/assets/images/products/product-small-04.jpg" />
                        </a>
                    </div>
                </div>
            ...
            <li>
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-3 no-margin">
                        <a href="#" class="thumb-holder">
                            <img alt="" src="${pageContext.request.contextPath}/resources/assets/images/blank.gif" data-echo="${pageContext.request.contextPath}/resources/assets/images/products/product-small-05.jpg" />
                        </a>
                    </div>
                </div>
            </li>
            ...
            <li>
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-3 no-margin">
                        <a href="#" class="thumb-holder">
                            <img alt="" src="${pageContext.request.contextPath}/resources/assets/images/blank.gif" data-echo="${pageContext.request.contextPath}/resources/assets/images/products/product-small-06.jpg" />
                        </a>
                    </div>
                </div>
            </li>
        ...
        <ul>
            <li>
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-3 no-margin">
                        <a href="#" class="thumb-holder">
                            <img alt="" src="${pageContext.request.contextPath}/resources/assets/images/blank.gif" data-echo="${pageContext.request.contextPath}/resources/assets/images/products/product-small-07.jpg" />
                        </a>
                    </div>
                </div>
            </li>
            ...
            <li>
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-3 no-margin">
                        <a href="#" class="thumb-holder">
                            <img alt="" src="${pageContext.request.contextPath}/resources/assets/images/blank.gif" data-echo="${pageContext.request.contextPath}/resources/assets/images/products/product-small-08.jpg" />
                        </a>
                    </div>
                </div>
            </li>
            ...
            <li>
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-3 no-margin">
                        <a href="#" class="thumb-holder">
                            <img alt="" src="${pageContext.request.contextPath}/resources/assets/images/blank.gif" data-echo="${pageContext.request.contextPath}/resources/assets/images/products/product-small-09.jpg" />
                        </a>
                    </div>
...
<div class="contact-info">
    <div class="footer-logo">
        <!--<img alt="logo_vmccnc" src="${pageContext.request.contextPath}/resources/assets/images/vmc_hmc.jpg" width="233" height="54"/>-->
        <img alt="vmc_and_hmc" src="${pageContext.request.contextPath}/resources/assets/images/vmc_and_hmc.svg" width="233" height="54"/>
<!--        <svg width="233px" height="54px" viewBox="0 0 233 54" version="1.1" xmlns="http://www.w3.org/2000/svg">
    ...
    <p class="regular-bold"><a href="/index"><spring:message code="footer.vmchmccnc" text="CNC machining center and milling machine." /></a> </p>
    
    <p>
<!--USA: +1 203 556-50-69 <br>-->
<!--Lithuania: +370 61 55-90-00 <br>
Belarus: +375 (29) 255-88-88 <br>
...
<br>-->
        ...
        <h3><spring:message code="footer.getintouch" text="Get in touch" /> </h3>
            
    <div class="social-icons">
      
        <ul>
                    <li><a href="https://plus.google.com/u/1/b/113654010509282407892/" >
                            <img alt="vmc_and_hmc" src="${pageContext.request.contextPath}/resources/assets/images/prettyPhoto/google+20.png" width="20"   />
                    </a> </li>
            <li><a href="https://www.youtube.com/channel/UCXZvi4ulrMI7SnJ5vde-BKA" >
                    <img alt="vmc_and_hmc" src="${pageContext.request.contextPath}/resources/assets/images/prettyPhoto/youtube15.png"  width="21"   />
                </a> </li>
            ...
            <li><a href="https://www.linkedin.com/company/vmccnc" class="fa fa-linkedin"></a></li>
...
<div class="link-widget">
    <div class="widget">
        <h3><spring:message code="footer.sections" text="Sections" /></h3>
        <ul>
            <!--<li><a href="index">Home</a></li>-->
            <li>
                <a href="/index">
                    <spring:message code="footer.home" text="Home" />
                </a>
            </li>
            ...
            <%@include file="all_departments.jsp" %>
                ...
                <li>
                    <a href="/video">
                        <spring:message code="footer.video" text="Video" />
                    </a>
                </li>
                        <li>
                            <a href="/site_map">
                                <spring:message code="footer.sitemap" text="Sitemap" />
                            </a>
                        </li>
            <li>
                <a href="/contact">
                    <spring:message code="footer.contactus" text="Contact Us" />
                </a>
            </li>
    ...
    <div class="copyright-bar">
        <div class="container">
            <div class="col-xs-12 col-sm-6 no-margin">
                <div class="copyright">
                    &copy; <a href="/index">VMC & HMC</a> - <spring:message code="footer.allrightsreserved" text="all rights reserved" />
                </div><!-- /.copyright -->
            </div>
            <div class="col-xs-12 col-sm-6 no-margin">
<!--                <div class="payment-methods ">
                    <ul>
                        <li><img alt="" src="${pageContext.request.contextPath}/resources/assets/images/payments/payment-visa.png"></li>
                        <li><img alt="" src="${pageContext.request.contextPath}/resources/assets/images/payments/payment-master.png"></li>
                        <li><img alt="" src="${pageContext.request.contextPath}/resources/assets/images/payments/payment-paypal.png"></li>
                        <li><img alt="" src="${pageContext.request.contextPath}/resources/assets/images/payments/payment-skrill.png"></li>
                    </ul>
                </div> /.payment-methods -->
            </div>
        </div><!-- /.container -->
